...
### Phase 3: Split Federated Learning (Weeks 3-6) 🔄 PENDING

**Components to implement:**

- [ ] `SplitClient` - Client-side training with LoRA
- [ ] `SplitServer` - Server-side computation
- [ ] `LoRAAdapter` - Efficient fine-tuning module
- [ ] Communication protocol
- [ ] Integration with GPT-2/LLaMA

**Prerequisites:** GPU access (recommended but not required)

---

### Phase 4: Privacy-Aware Aggregation (Weeks 6-8) 🔄 PENDING

**Components to implement:**

- [ ] `AggregationEngine` - Heterogeneous LoRA weight merging
...
### Phase 5: Privacy Evaluation (Weeks 8-10) 🔄 PENDING

**Components to implement:**

- [ ] 5 privacy attacks (MIA, AIA, DRA, MOA, PEA)
...
### Phase 6: Evaluation & Demo (Weeks 10-12) 🔄 PENDING

**Deliverables:**

- [ ] Benchmarks on GLUE, SQuAD, E2E
...
- 🔄 100+ GPU-hours for full experiments
- 🔄 8GB+ VRAM for LLaMA-7B
...
| 3-6   | Split FL        | 🔄 Pending  | SplitClient, SplitServer, LoRAAdapter, training loop         |
| 6-8   | Aggregation     | 🔄 Pending  | AggregationEngine, privacy tests                             |
| 8-10  | Privacy Eval    | 🔄 Pending  | 5 attacks, 9 defenses, VFLAIR integration                    |
| 10-12 | Demo            | 🔄 Pending  | Benchmarks, final demo, report                               |
