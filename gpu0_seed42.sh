...
echo "========================================"
echo "GPU 0 - Seed $SEED - Method: $METHOD"
...
if [ $? -eq 0 ]; then
    ...
    # Atlas writes results to: results/atlas_integrated_full_<ablation>_seed<seed>.json
    ...
    if [ "$SESSION" != "3" ]; then
        ...
        echo ""
        echo "Next: ./gpu0_seed42.sh $((SESSION + 1)) $METHOD"
    else
        echo ""
