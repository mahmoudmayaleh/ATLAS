# GPU 1 - Seed 123 - GPT-2 XL Experiments
...
Write-Host "GPU 1 - Seed $SEED - Method: $Method" -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    if ($Session -ne '3') {
        ...
        Write-Host "`nNext: .\gpu1_seed123.ps1 -Session $($Session + 1) -Method $Method" -ForegroundColor Cyan
    } else {
